...
project = 'Workbench'
copyright = '2014, SuperCowPowers LLC'
...
latex_documents = [
  ('index', 'Workbench.tex', 'Workbench Documentation',
   'Brian Wylie', 'manual'),
]
...
man_pages = [
    ('index', 'workbench', 'Workbench Documentation',
     ['Brian Wylie'], 1)
]
...
texinfo_documents = [
  ('index', 'Workbench', 'Workbench Documentation',
   'Brian Wylie', 'Workbench', 'One line description of project.',
   'Miscellaneous'),
]
